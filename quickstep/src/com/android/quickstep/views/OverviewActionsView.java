...
public class OverviewActionsView<T extends OverlayUICallbacks> extends FrameLayout
    ...
    public OverviewActionsView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        internalFilter.addAction("sprocomm.intent.action.OVERVIEW_TOGGLE");
        context.registerReceiver(mBannerActionBroadcastReceiver, internalFilter, RECEIVER_EXPORTED);
    }
    ...
    private final BroadcastReceiver mBannerActionBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if ("sprocomm.intent.action.OVERVIEW_TOGGLE".equals(action)){
                Log.d("split","action receive!! " + mCallbacks);
                if(mCallbacks != null) {
                    mCallbacks.onSplit();
                    Log.d("split","do success");
                }
            }
        }
    };
