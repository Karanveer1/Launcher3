...
public class RktVideoView extends SurfaceView
        implements RktMediaController.MediaPlayerControl, OrientationDetector
    ...
    private RktMediaController mMediaController;
    ...
    private RktVideoView.VideoViewCallback videoViewCallback;

    public RktVideoView(Context context) {
        this(context, null);
    }

    public RktVideoView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RktVideoView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mContext = context;
        TypedArray a = mContext.obtainStyledAttributes(attrs, R.styleable.RktVideoView, 0, 0);
        mFitXY = a.getBoolean(R.styleable.RktVideoView_uvv_fitXY, false);
        mAutoRotation = a.getBoolean(R.styleable.RktVideoView_uvv_autoRotation, false);
        a.recycle();
        initVideoView();
    }
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(RktVideoView.class.getName());
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            info.setClassName(RktVideoView.class.getName());
        }
    }
    ...
    @Override
    public void onOrientationChanged(int screenOrientation, OrientationDetector.Direction
            direction) {
        if (!mAutoRotation) {
            return;
        }
    ...
    public void setMediaController(RktMediaController controller) {
...
//                    }
    ...
    private void enableOrientationDetect() {
        if (mAutoRotation && mOrientationDetector == null) {
            ...
            mOrientationDetector.setOrientationChangeListener(RktVideoView.this);
...
*/
    ...
    public interface VideoViewCallback {
     ...
     /*   void playCompleted(final MediaPlayer mediaPlayer);

        void loadingStart(final MediaPlayer mediaPlayer);*/
    }

    public void setVideoViewCallback(RktVideoView.VideoViewCallback callback) {
