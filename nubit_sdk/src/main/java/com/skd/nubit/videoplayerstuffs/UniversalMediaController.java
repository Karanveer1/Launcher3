...
//    private boolean mFullscreenEnabled = false;
    ...
    ImageView img_audio_controller;

    public UniversalMediaController(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        TypedArray a = mContext.obtainStyledAttributes(attrs, R.styleable.RktMediaController);
        mScalable = a.getBoolean(R.styleable.RktMediaController_uvv_scalable, false);
        a.recycle();
        init(context);
    }
    ...
    private void initControllerView(View v) {
        ...
        img_audio_controller = v.findViewById(R.id.img_audio_controller);
        ...
        img_audio_controller.setOnClickListener(new OnClickListener() {
            @Override
...
//    }
    ...
    private void muteUnmute() {
        ...
        //If you want to player is mute ,then set_volume variable is zero.Otherwise you may
        // supply some value.

        if (current_volume == 0) {

            try {
                img_audio_controller.setImageResource(R.drawable.unmute_icon);
            ...
            try {
                img_audio_controller.setImageResource(R.drawable.mute_icon);
                muteAudio();
    ...
    public void hide_img_audio_controller() {

        img_audio_controller.setVisibility(View.GONE);


    }

    public void show_img_audio_controller() {

        img_audio_controller.setVisibility(View.VISIBLE);
