...
public class RktMediaController extends FrameLayout {
...
//    private boolean mFullscreenEnabled = false;
    ...
    public RktMediaController(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    ...
    public RktMediaController(Context context) {
        super(context);
        init(context);
    }
