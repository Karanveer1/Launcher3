...
import com.skd.nubit.adapters.VideoPlayerRecyclerAdapter;
...
public class VideoPlayerRecyclerView extends RecyclerView {
    ...
    private String GRID_YOUTUBE_ID = "qq3CdxrFeJg";
...
//        Exoplayer.getSharedInstance(this).playStream(downloadUrl);
    }
    ...
    private void animateVolumeControl(){
        if(volumeControl != null){
            ...
            if(volumeState == VolumeState.OFF){
                requestManager.load(R.drawable.profile_back)
                        .into(volumeControl);
            }
            else if(volumeState == VolumeState.ON){
                requestManager.load(R.drawable.profile_back)
