...
class GetVideoData extends AsyncTask<Void, Void, String>

{
    ...
    protected String doInBackground(Void... params) {
        ...
        try {
            ...
            String str_response = MyUtility.hitGetVideoApi(MyApplication.ctx, MyUtility
                    .getmainDataAPI);
...
//                editor.putString(KEY_CUSTOM_MODEL_ARRAY, json);
                ...
                if (save_json_jsonobject != null) {
                    if (!TextUtils.isEmpty(save_json_jsonobject.toString())) {
                        ...
                        MyApplication.app_editor.putString("save_app_video_Json", String.valueOf
                                (json));
