...
class GetSportsData extends AsyncTask<Void, Void, String>

{
    ...
    protected String doInBackground(Void... params) {
        ...
        try {
            ...
            String str_response = MyUtility.hitGetSportsAPI(MyApplication.ctx, MyUtility
                    .getmainDataAPI);

            if (str_response != null && !TextUtils.isEmpty(str_response)) {
                Log.e("getSportsdad",">manininn>" + str_response);
...
//                    }
                    ...
                    Log.e("getSportsdad",">category>" + category);
                ...
                Log.e("getSportsdad","newArray>00>" + newArray.size() + ">>" + newArray.get(1).getTitle());
...
//                editor.putString(KEY_CUSTOM_MODEL_ARRAY, json);
                ...
                if (save_json_jsonobject != null) {
                    if (!TextUtils.isEmpty(save_json_jsonobject.toString())) {
                        ...
                        MyApplication.app_editor.putString("save_app_sports_news_Json", String.valueOf
                                (json));
