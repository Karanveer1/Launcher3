...
public class NewsByPub_Adapter extends RecyclerView.Adapter<NewsByPub_Adapter.MyViewHolder> {
    private List<NewsByPub_Pojo> android;
    Context context;
    int imageheight;
    String getLanguage = "";
    ...
    public NewsByPub_Adapter(Context context, List<NewsByPub_Pojo> android) {
        ...
        try {
            if (like_dLike_ArrayList.size() != 0 & like_dLike_ArrayList.size() > 0) {
                ...
                if (!(date_1.equals(date_2))) {
                    new NewsByPub_Adapter.HitforLikeDislike().execute();
                }
    ...
    @Override
    public NewsByPub_Adapter.MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout
                .bottom_news_adapter_items, viewGroup, false);

        NewsByPub_Adapter.MyViewHolder mViewHold = new NewsByPub_Adapter.MyViewHolder(view);
        return mViewHold;
    }

    @Override
    public void onBindViewHolder(NewsByPub_Adapter.MyViewHolder viewHolder, int i) {

        final NewsByPub_Pojo dataItem = android.get(i);
        final NewsByPub_Adapter.MyViewHolder myViewHolder = viewHolder;
        ...
        myViewHolder.center_play_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (myViewHolder.mVideoView.isPlaying()) {
                    ...
                    myViewHolder.center_play_btn.setImageResource(R.drawable.uvv_itv_player_play);
                    try {
...
//                cachedHeight = (int) (width * 9f / 16f);
        ...
        //AdFetcher instance = new AdFetcher("ca-app-pub-3940256099942544/9782828514", "");

        //!TextUtils.isEmpty(dataItem.getAd_unit_id()
        ...
        myViewHolder.img_bottomNews_dislike.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                /*try {
                    ArrayList<Like_DLike_Pojo> like_dLike_ArrayList = new ArrayList<>();
