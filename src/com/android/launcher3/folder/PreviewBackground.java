...
public class PreviewBackground extends CellLayout.DelegatedCellDrawing {
    ...
    private static final int BG_OPACITY = 128;
    private static final int MAX_BG_OPACITY = 160;
    ...
    public void setup(Context context, ActivityContext activity, View invalidateDelegate,
        ...
        mBgColor = ta.getColor(R.styleable.FolderIconPreview_folderBackgroundColor, 0);
        ta.recycle();
