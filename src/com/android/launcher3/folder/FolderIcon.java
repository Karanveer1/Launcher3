...
public class FolderIcon extends FrameLayout implements FolderListener, IconLabelDotView,
    ...
    public boolean hasDot() {
        return (mDotInfo != null && mDotInfo.hasDot()) || getDotCount() > 0;
    }
            ...
            if (wsi.itemType == LauncherSettings.Favorites.ITEM_TYPE_APPLICATION) {
                ...
                if (!components.contains(tempKey)) {
                    ...
                    if (wsi.unreadNum > 0) {
                        ...
                        DotInfo dotInfo = mActivity.getDotInfoForItem(wsi);
                        if (NotifyDotNumWrapper.showNotifyDotsNum(getContext()) && null != dotInfo) {
