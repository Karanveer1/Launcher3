...
public class FolderAnimationManager {
    ...
    public AnimatorSet getAnimator() {
        ...
        int folderBackgroundColor = Themes.getAttrColor(mContext, R.attr.folderBackgroundColor);
        if (mIsOpening) {
            //finalColor = folderBackgroundColor;
            finalColor = setColorAlphaBound(folderBackgroundColor, mPreviewBackground.getBackgroundAlpha());
        } else {
            finalColor = mFolderBackground.getColor().getDefaultColor();
        }
        final int initialColor = setColorAlphaBound(
                folderBackgroundColor, mPreviewBackground.getBackgroundAlpha());

        mFolderBackground.mutate();
        mFolderBackground.setColor(mIsOpening ? initialColor : finalColor);
        mFolder.updateBgStrokeColor(mFolderBackground);
