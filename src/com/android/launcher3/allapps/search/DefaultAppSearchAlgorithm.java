...
import static com.android.launcher3.allapps.BaseAllAppsAdapter.VIEW_TYPE_MORE_SEARCH;
    ...
    public void doSearch(String query, SearchCallback<AdapterItem> callback) {
        mAppState.getModel().enqueueModelUpdateTask(new BaseModelUpdateTask() {
            ...
            public void execute(@NonNull final LauncherAppState app,
                ...
                result.add(getSearchMoreAdapterItem(query));
                mResultHandler.post(() -> callback.onSearchResult(query, result));
            }
        });
    }

    private static AdapterItem getSearchMoreAdapterItem(String query) {
        AdapterItem item = new AdapterItem(VIEW_TYPE_MORE_SEARCH);
