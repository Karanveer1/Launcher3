...
public class InvariantDeviceProfile {
    ...
    private InvariantDeviceProfile(Context context) {
        ...
        String strDeviceProj = getDeviceProj();
        Log.d(TAG, "InvariantDeviceProfile strDeviceProj : " + strDeviceProj);
        if (TextUtils.isEmpty(gridName) /*&& "helio_50".equals(strDeviceProj)*/) {
            gridName = "4_by_4";
        }
    ...
    private static String getDeviceProj() {
        String mDeviceProj = null;
        try {
            mDeviceProj = SystemProperties.get("ro.product.device", "");
