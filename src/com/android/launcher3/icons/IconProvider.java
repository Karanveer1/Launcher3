...
public class IconProvider {
    ...
    public IconProvider(Context context) {
        mContext = context;
        mCalendar = parseComponentOrNull(context, R.string.abandoned_clean_this);
        mClock = parseComponentOrNull(context, R.string.abandoned_clean_this);
    }
    /**
    ...
    public static SafeCloseable registerIconChangeListener(Context context,
        ...
        ComponentName calendar = parseComponentOrNull(context, R.string.abandoned_clean_this);
        ComponentName clock = parseComponentOrNull(context, R.string.abandoned_clean_this);
    ...
    private static class DateTimeChangeReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            ComponentName calendar =
                    parseComponentOrNull(context, R.string.abandoned_clean_this);
            if (calendar != null) {
