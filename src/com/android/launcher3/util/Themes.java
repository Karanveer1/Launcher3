...
public class Themes {
    ...
    public static boolean isThemedIconEnabled(Context context) {
        return LauncherPrefs.get(context).get(THEMED_ICONS) && isDefaultTheme(context);
    }

    //sprocomm add begin
    public static boolean isDefaultTheme(Context context) {
        String themePath = Settings.System.getString(context.getContentResolver(), "theme_path");
        if (TextUtils.isEmpty(themePath) || themePath.equals("DefaultTheme")) {
            return true;
        }
        return false;
    }
