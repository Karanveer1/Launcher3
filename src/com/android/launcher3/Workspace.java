...
public class Workspace<T extends View & PageIndicator> extends PagedView<T>
    ...
    private DoubleTapToLockHelper mDoubleTapToLockHelper;
    /**
    ...
    public Workspace(Context context, AttributeSet attrs, int defStyle) {
        ...
        mDoubleTapToLockHelper = DoubleTapToLockHelper.getInstance(this);
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        mDoubleTapToLockHelper.onInterceptTouchEvent(ev);
    ...
    boolean hasRegisterContentObserver = false;
    @Override
    protected void onFinishInflate() {
        if(!hasRegisterContentObserver){
            hasRegisterContentObserver = mDoubleTapToLockHelper.onFinishInflate();
        }
