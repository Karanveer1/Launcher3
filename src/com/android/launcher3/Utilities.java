...
public final class Utilities {
    ...
    public static int pxFromSp(float size, DisplayMetrics metrics, float scale) {
        ...
        Log.d(TAG,"size "+ size+"value "+value +" TypedValue "+ TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, size, metrics)+" scale "+scale);
        ...
        if (info.itemType == LauncherSettings.Favorites.ITEM_TYPE_APPLICATION) {
            ...
            if (!FeatureOption.SPRD_DYNAMIC_ICON_SUPPORT) {
                return activityInfo == null ? null : LauncherAppState.getInstance(context)
                            .getIconProvider().getIconNoDynamic(
