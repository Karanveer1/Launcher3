...
public class OptionsPopupView extends ArrowPopup<Launcher>
    ...
    public static ArrayList<OptionItem> getOptions(Launcher launcher) {
        ...
        /*options.add(new OptionItem(launcher,
                ...
                R.drawable.ic_theme,
                LAUNCHER_SETTINGS_BUTTON_TAP_OR_LONGPRESS,
                OptionsPopupView::startThemeSettings));*/
        return options;
    }
    ...
    //sprocomm add begin
    private static boolean startThemeSettings(View view) {
        TestLogging.recordEvent(TestProtocol.SEQUENCE_MAIN, "start: startThemeSettings");
        Launcher launcher = Launcher.getLauncher(view.getContext());
        launcher.startActivity(new Intent("sprocomm.intent.action.THEME")
