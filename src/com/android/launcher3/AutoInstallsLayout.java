...
public class AutoInstallsLayout {
    ...
    protected class AutoInstallParser implements TagParser {
        ...
        public int parseAndAdd(XmlPullParser parser) {
            ...
            final Intent intent = new Intent(Intent.ACTION_MAIN, null)
                    ...
                    .setFlags(Intent.FLAG_ACTIVITY_NEW_TASK
                            | Intent.FLAG_ACTIVITY_RESET_TASK_IF_NEEDED);
            return addShortcut(getAppName(mContext,packageName), intent,
    ...
    public static String getAppName(Context context,String packname){
        ...
        try {
            ...
            Log.d(TAG, "getAppName appName:" + info.loadLabel(pm).toString());
            return info.loadLabel(pm).toString();
        } catch (PackageManager.NameNotFoundException e) {
            // TODO Auto-generated catch block
            Log.d(TAG, "getAppName 02:");
            e.printStackTrace();
        }
        Log.d(TAG, "getAppName appName:" + packname);
